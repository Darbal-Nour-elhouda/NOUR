...
int main() {
   ...
   // if (runSimpleTests(SELECTED_TESTS)) {
    ...
    //Image IM("res/A.png");
    //IM.lighten(0.5);
    //IM.writeToFile("res/IM-lighted1.png");

//    Image IM("res/euromed_image.png");
//    IM.saturate(-0.5);
//    IM.writeToFile("res/IM_saturated.png");

    //    Image IM("res/euromed_image.png");
    //    IM.rotateColor(100);
    //    IM.writeToFile("res/IM_rotated.png");
//      Grayscale im_g("res/euromed_image.png");
//      im_g.writeToFile("res/im_g.png");

//    Illini IM("res/euromed_image.png",11,216);
//    IM.writeToFile("res/IM_ILLINI.png");
    Image IM("res/euromed_image.png");
   spotlight im_g("res/euromed_image.png",100,100);
       im_g.writeToFile("res/IM_spot.png");
